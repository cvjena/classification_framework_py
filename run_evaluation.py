...
def run():
    ...
    d.use_images_in_folder("/home/jaeger/data/croatianFishDataset1-1Dir/")
    ...
    c.add_algorithm(Decaf(basedir+'imagenet.jeffnet.epoch90',basedir+'imagenet.jeffnet.meta','fc6_cudanet_out'))
    c.add_algorithm(MulticlassSVM())
    #c.train(d)
